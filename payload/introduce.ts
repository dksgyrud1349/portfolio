...
const introduce: IIntroduce.Payload = {
  ...
  contents: [
    ...
    '단순히 기능을 구현하는 데 그치지 않고, 운영 중 발생하는 문제를 구조적으로 개선하는 것을 중요하게 생각합니다. 인천 MICE뷰로에서 사내 테스트로 발견된 오류 100여 건을 기간 내 전량 해결하고 오류 0건 운영 상태를 달성한 경험, 여주 파크골프장에서 고정형 QR 부정 이용 문제를 OTP 기반 동적 QR 인증 체계로 원천 차단한 경험이 이를 잘 보여줍니다.',
    '실무 역량을 바탕으로 직장 동료들과 키워드·위치 매칭 기반 장소 추천 앱 서비스 "핏플(fitpl)"을 개발하고, Next.js 사이드 프로젝트를 진행하며 프론트엔드 역량도 꾸준히 확장하고 있습니다.',
