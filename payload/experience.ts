      ...
      positions: [
        {
          ...
          descriptions: [
            {
              text: '통합 예약-결제-입장/탑승 솔루션 구축 참여 및 운영',
              children: [
                '천안 유관순 파크골프장, 마포 순환열차버스 : 신규 서비스 설계부터 런칭, 실서버 운영까지 전체 라이프사이클 참여',
                '여주 파크골프장 : 기존 시스템 고도화 및 동적 QR 시스템 도입을 통한 시스템 안정화, 복합 인증(할인 등) 로직 개발 참여',
                '하드웨어 연동 : 카드리더기, 안면인식기, 키오스크, QR 게이트, 태블릿 등 멀티 디바이스와 백엔드 API 실시간 연동 개발 참여',
              ],
            },
            {
              text: '공공기관 웹 서비스 안정화 및 품질 관리',
              children: [
                '인천 MICE뷰로 : 메인 담당자로서 기존 장애 및 오류 약 100여 건 전수 해결 및 유지보수 6개월 차 이후 "결함 0건 달성"',
              ],
            },
          ],
          skillKeywords: [
